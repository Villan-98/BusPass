...
const sendMail=function(type,emailId)
{
    ...
    if(type===1)
    {
        text="We are pleased to inform you that your application for the issuance of bus-pass is registered." +
            " You may check your application's status at 'domainName/application/status"
    }
    else if(type===2)
    {
        text="We are sorry to inform you that your application for the bus-pass is rejected by the transport head of your college\n"+
    ...
    {
        text="We are sorry to inform you that your application for the bus-pass is rejected by the Depot-Manager\n"+
            "Your paid amount will be refunded back in 15 working days\n"+
    ...
    {
        text="We are pleased to inform you that your application for bus-Pass is accpeted at all levels of verification."+
